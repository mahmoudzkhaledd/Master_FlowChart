...
enum ImageFunction {
	start, End, read, write, simpleAssign, ConditionStatement, ConnectorButton, Exit, Copy, Cut, Paste, Delete, Redo, Undo, DownArrow, UpArrow,simulation
	,zoomIn,zoomOut,clear,resize,designMode,generateCode,step_by_step,validate,run,editStatement,varAssign,operatorassignment,editConnector,
	comment,selection,moveObj,multipleSelection,save,load,complexassign,
};
class image {
...
public:
	bool isDrawn;
	bool t; // 0 for toolbar horizontal , 1 for toolbar vertical 
